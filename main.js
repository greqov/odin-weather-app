    ...
    daily.forEach((day) => {
      ...
      str += `
        <div class="text-center mb-8">
          <span class="block opacity-60">${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(dt * 1000, 'E d/L')}</span>
          <img
            class="block mx-auto"
